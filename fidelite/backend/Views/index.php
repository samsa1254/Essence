        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="margin-top: 20px;margin-bottom: 20px;">
                    <div class="card-body">
                        <h2 class="pull-left">Info Utilisateur <a href="create.php" class="btn btn-success pull-right">Ajouter un Utilisateur</a><a href="../search/search.php" class="btn btn-success pull-right">Chercher un Utilisateur</a></h2>
...
function showPosts($link, $current_page_num, $page_limit, $page_offset){
    ...
    $sqli = mysqli_query($link,"SELECT * FROM `fidel` ORDER BY FID LIMIT $page_limit OFFSET $page_offset");
