                        ...
                        <div class="login-form">
                            <form action="verifier.php" method="post">
                                <div class="col-md-6 mb-3">
                                  ...
                                  <input type="text"  name="mailconnect" value="" placeholder="email">
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="mot-depasse">mot de passe<span>*</span></label>
                                  <input type="password"  name="mdpconnect" value="" required placeholder="mot de passe">
                                </div>
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="mdpoub.php">Mot de passe oublié?</a>
                                    </label>
                                </div>
