                    ...
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="images/icon/oussema.jpg" alt="OUSSEMA JERFEL" />
                                </div>
                                <div class="content">
                                    <a class="js-acc-btn" href="#">OUSSEMA JERFEL</a>
                                </div>
                                <div class="account-dropdown js-dropdown">
                                    <div class="info clearfix">
                                        ...
                                        <div class="content">
                                            <h5 class="name">
                                                <a href="#">oussema jerfel</a>
                                            </h5>
                                            <span class="email">oussema jerfel@example.com</span>
                                        </div>
                                    </div>
                                    <div class="account-dropdown__body">
                                        <div class="account-dropdown__item">
        ...
        <div class="sub-header-mobile-2 d-block d-lg-none">
            <div class="header__tool">
                ...
                <div class="account-wrap">
                    <div class="account-item account-item--style2 clearfix js-item-menu">
                        <div class="image">
                            <img src="images/icon/avatar-01.jpg" alt="oussema jerfel" />
                        </div>
                        <div class="content">
                            <a class="js-acc-btn" href="#">oussema jerfel</a>
                        </div>
                        <div class="account-dropdown js-dropdown">
                            <div class="info clearfix">
                                ...
                                <div class="content">
                                    ...
                                    <span class="email">oussemajerfel@example.com</span>
                                </div>
                            </div>
                            <div class="account-dropdown__body">
                                <div class="account-dropdown__item">
            ...
            <form name="f" action="ajoutproduit.php" method="POST">
                <div class="row">
                    <div class="col-md-6 pr-md-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Id Produit" name="id" id="IdProduit">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 pr-md-1">
                        <div class="form-group">
                            <label>nom</label>
                            <input type="text" class="form-control" placeholder="nom de produit" name="nom" id="nom">
                ...
                <div class="row">
                    <div class="col-md-6 pr-md-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="categorie" name="categorie" id="Type">
